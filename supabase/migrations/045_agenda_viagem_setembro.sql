...
from (values
  ('2026-09-21', 'viagem', 'Deslocamento: Indaiatuba → Monte Santo de Minas (3h)', 'Monte Santo de Minas - MG', 'Deslocamento',     'Agenda comercial - viagem 21/09 a 03/10', 'confirmado', null),
  ...
  ('2026-09-22', 'viagem', 'Deslocamento: Monte Santo de Minas → Curvelo (8h)',    'Curvelo - MG',              'Deslocamento',     'Agenda comercial - viagem 21/09 a 03/10', 'confirmado', null),
  ...
  ('2026-09-23', 'viagem', 'Deslocamento: Curvelo → Corinto (40 min)',             'Corinto - MG',              'Deslocamento',     'Agenda comercial - viagem 21/09 a 03/10', 'confirmado', null),
  ('2026-09-23', 'visita', 'Triângulo',                                            'Corinto - MG',              'Visita comercial', 'Agenda comercial - viagem 21/09 a 03/10', 'confirmado', '%Tri%ngulo%'),

  ('2026-09-24', 'viagem', 'Deslocamento: Corinto → Pavão (11h)',                  'Pavão - MG',                'Deslocamento',     'Agenda comercial - viagem 21/09 a 03/10', 'confirmado', null),
  ('2026-09-24', 'visita', 'JM Plantar',                                           'Pavão - MG',                'Visita comercial', 'Agenda comercial - viagem 21/09 a 03/10', 'confirmado', '%JM%Plantar%'),

  ('2026-09-25', 'viagem', 'Em Pavão',                                             'Pavão - MG',                'Viagem comercial', 'Dia em Pavão - sem visita marcada',       'confirmado', null),

  ('2026-09-26', 'viagem', 'Deslocamento: Pavão → Capelinha (5h)',                 'Capelinha - MG',            'Deslocamento',     'Agenda comercial - viagem 21/09 a 03/10', 'confirmado', null),

  ('2026-09-27', 'viagem', 'Deslocamento: Capelinha → Montes Claros (4h)',         'Montes Claros - MG',        'Deslocamento',     'Agenda comercial - viagem 21/09 a 03/10', 'confirmado', null),
  ...
  ('2026-09-30', 'viagem', 'Deslocamento: Montes Claros → Chapada Gaúcha (7h)',    'Chapada Gaúcha - MG',       'Deslocamento',     'Agenda comercial - viagem 21/09 a 03/10', 'confirmado', null),
  ...
  ('2026-10-02', 'viagem', 'Deslocamento: Chapada Gaúcha → Indaiatuba (15h)',      'Indaiatuba - SP',           'Deslocamento',     'Viagem de volta - 15h, chega dia 03/10',  'confirmado', null),
  ...
  ('2026-10-03', 'viagem', 'Chegada em Indaiatuba',                                'Indaiatuba - SP',           'Deslocamento',     'Continuação da viagem de volta (saída 02/10)', 'confirmado', null)
